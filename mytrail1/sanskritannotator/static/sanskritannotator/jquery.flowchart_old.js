...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        // getLinkRelname: function (linkId) {
        //     var linkData = this.data.links[linkId];
        //     var rname = 'link';
        //     if (typeof linkData.relationame != 'undefined') {
        //         rname = linkData.relationame;
        //     }
            
        //     return rname;
        // },

        // setLinkRelname: function (linkId, rname) {
        //     this.data.links[linkId].relationame = rname;
        //     this.callbackEvent('afterChange', ['link_change_RelName']);
        // },
